...
This paper argues that such comparisons may be taking place at the wrong level of description.

The history of physics provides a useful analogy. Statistical mechanics explains the behavior of macroscopic systems without requiring an explicit simulation of every microscopic interaction. Instead, the collective effects of molecular interactions are summarized by an effective free-energy function that governs the large-scale dynamics of the system. Thermodynamics is therefore not a model of molecular structure, but an effective theory of its observable behavior.

We propose that modern generative neural networks should be interpreted in a similar manner. Rather than viewing transformers or diffusion models as candidate models of the brain's circuitry, we suggest viewing them as effective theories of cognitive dynamics. Their parameters need not correspond to neurons, synapses, or cortical microcircuits. Instead, they may be regarded as learning an effective dynamical landscape that captures the observable evolution of perception and thought. The underlying biological implementation—encoded in the brain's connectome and cellular physiology—remains hidden, just as microscopic molecular interactions remain hidden within thermodynamic descriptions.
...
Predictive processing provides a useful conceptual setting for this proposal. On this view, perception is not a passive reconstruction of sensory input. The brain continuously generates expectations about the state of the world and revises them in response to incoming sensory evidence. Perception therefore reflects an interaction between internally generated predictions and signals produced by the environment.
