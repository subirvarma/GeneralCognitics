...
This opens the way to model other aspects of the brain using EBMs. The brain can clearly generate video, which is nothing more than a succession of images, for example when we are imagining some scenario in our minds.
