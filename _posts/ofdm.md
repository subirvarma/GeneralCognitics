...
So what changed? It was not due to the iPhone, since this handset was launched in 2007.
...
The other big issue with 3G was the PHY or physical layer protocol that was used, which was based on a technology called Code Division Multiple Access or CDMA. CDMA paired well with circuit switching, so it was not very well suited for data. '
However it had a very strong political backing, in the form og Qualcomm Networks which held a number of important CDMA patents.
