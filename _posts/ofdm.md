...
It would not be an exaggeration to say that today we are living in the age of OFDM! Whether you are surfing the web on your cellphone, or streaming movies on your cable modem, or conencting to the web at the coffee shop, it is all happening over links that use OFDM modulation. It is the base technology on which our modern connected worls runs!
