...
$$ a_n = {1\over T}\int_{-{T\over 2}}^{T\over 2} x(t)\cos(2\pi nft) dt,\ for\ n\ge 1 $$

$$ b_n = {1\over T}\int_{-{T\over 2}}^{T\over 2} x(t)\sin(2\pi nft) dt,\ for\ n\ge 1 $$
...
$$ x_N(t) = \sum_{n=-N}^N c_n e^{2\pi nft}\ \ \ where\ \ \ c_n = {1\over T}\int_{-{T\over 2}}^{T\over 2} x(t)e^{-2\pi nft} dt  $$
