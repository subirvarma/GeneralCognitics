...
This paper develops a subset of Ralph's six modalities (namely models for vision, speech and valence) as a proof concept, with models for praxis (motor/action semantics) and functional knowledge left for future work.
...
It is worth noting that the status of the unified ATL hub hypothesis is more actively debated than the original 2017 formulation might suggest. A meta-analysis of 164 functional neuroimaging studies found that ATL activation during semantic tasks is not consistently reported, and traced this inconsistency to identifiable methodological factors — including the use of PET versus fMRI (fMRI is more susceptible to signal distortion in this region), scanner field of view, choice of baseline task, and whether ATL was included as a region of interest ([Visser, Jefferies, & Lambon Ralph, 2010](https://direct.mit.edu/jocn/article-abstract/22/6/1083/4865/Semantic-Processing-in-the-Anterior-Temporal-Lobes?redirectedFrom=fulltext)). 
