...
The IVC existed in the time period 3300 BCE to 1700 BCE, with the period 2700-1900 BCE defined as the Mature Phase of the civilization. During this phase the IVC cities took on a standard appearance, with a common script. Their script has not been deciphered unfortunately, so we don't even know what they called themselves, though Sumerian documents refer to the country of *Meluhha* in the East with whom they had trade relations, which could very well be their name. All mention of Meluhha came to an end after 1750 BCE which coincides with the date at which the IVC came to an end.
Incidentally it is thought that the Sanskrit *Mlecha*, which refers to an outcast was probably derived from *Meluha*. Indeed when I was growing up in a small town in Northen Bihar, I remember my mother using the term *Mlech* when she was particularly upset with one of the servants at our home. 
...
The other clue the origins of the IVC came from genetic sequencing data and is shown in the figure. The figure shows that people of the IVC had genes from two sources:
...
### What the People of the IVC Look Like?
...
The ruins of the IVC have left us with almost no information about how the cities were governed or who the rulers were. Other civilizations have left written records about their kings, and it is also easy to identify their palaces among the ruins. However the unformity of the all the IVC cities scattered over such a wide area, and the fact that artifacts such as seals were idential everywhere, shows that there must have been some kind of central authority. The transition from hunter-gatherer stage to farming requires someone in power who can co-ordinate the agricultural activities, maintain irrigation infrastructure, defend the settlement from external invaders also also provide internal policing. Such a central authority sustains itself by taxing its subjects which pays for its activities. 
