...
Unbeknownst to Einstein, Brownian Motion had already been analyzed five years earlier by Louis Bachelier in the context of a model for the stock market.
...
![](https://subirvarma.gnsforming an image into noiseithub.io/GeneralCognitics/images/weiner21.png) 

Figure: Prices of European Call Options as computed by the Black-Scholes model (dotted line) and the Truncated Levi Distribution based model
