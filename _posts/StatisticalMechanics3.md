...
- Vision neurons encode all possible images that we can see. Not clear how they get trained.
- Input from eyes is like a context.
- The context can also come from data stored in the brain, visual memories.
