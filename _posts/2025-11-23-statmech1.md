...
- Models for magnetism
  ...
  - Ising model in 2 or more dimensions: Phase transistions
...
- At very low temperatures $\beta\rightarrow\infty$, and as a result the average spin $\sigma_{av} = 1$ and the average energy is minimized at $e_{av} = -J$.  Hence at low temperatures the infuence of the external magnetic field overcomes the random thermal fluctuations and as a result each spin becomes perfectly aligned with the external field, and this is lowest energy configuration.
