...
The history of physics provides a useful analogy. Statistical mechanics explains how simple effective descriptions of macroscopic matter can emerge from complex microscopic interactions. In equilibrium and near-equilibrium systems, the collective effects of many microscopic degrees of freedom can often be summarized by thermodynamic potentials or effective free-energy landscapes defined over a smaller set of macroscopic variables. Thermodynamics consequently provides an effective description of observable behavior rather than a direct account of molecular structure. This distinction between microscopic mechanisms and effective descriptions is common throughout physics but has received comparatively little attention in computational neuroscience, where advances in AI are often interpreted primarily through architectural similarities to biological neural circuits.
