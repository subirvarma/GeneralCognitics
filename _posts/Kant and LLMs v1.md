...
- Source 1 is the information coming to us from the external world to our sensory organs. Hence there is an external world that does exist out there, unlike what the Idealists claimed, but we don't have access to it using senses (hence the Transcedentalism). Kant called this the Noumenon.
