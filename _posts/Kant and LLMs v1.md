...
Fortunately there are several new ideas that scientists and philosophers have come up with in the last two decades and it seems that some of Kant's ideas, and especially his theory that the mind is responsible for creating our reality, are starting to become very relevant.  We have finally started to make some progress with  problems ranging from the interpretation of Quantum Mechanics to theories of how the mind works. In this essay I will start by surveying the state of knowledge in these fields, followed by some ideas on how these can be applied to the interpretation of mathematical models for the mind in the form of ANNs.
...
- Human Cognition: Our brain consists of a large number of interconnected neurons, which are somehow able to create our Perceived Reality, and enable us to exist in it.
- Artificial Neural Networks: These are also Mathematical models, but of a special kind since they serve as models for the mind. These models are very different than classical Newtonian models that are used in Physics.
...
- The Physical World exists independent of our minds, and what we perceive is a true reflection of it. Hence the mind is like a window into reality. The job of the scientist was to discover the eternal Laws of Nature which have existed from the beginning of time and are independent of whether humans existed or not.
- The Physical World can be modeled using mathematics. Galileo had a nice quote in this regard, "The Laws of Nature are written in the language of mathematics". Scientists thought that by discovering the mathematical Laws of Nature they were plumbing the depths of reality, so that indeed reality at its very core was a set of mathematical equations. 
...
- A subset of the world of mathematical objects serves as a model for the Physical World. A stronger version of this belief is that the Physical World at its core is nothing else but a set of mathematical equations (for an example of this belief see the book "Our Mathematical Universe" by Max Tegmark).
...
The other problem with the post-Cartesian framework for science emerges when we try to use it to model the brain.
The framework actually opens up the possibility of modeling the mind using mathematical models since the framework says that the brain is part of the Physical Worldand all of the Physical World can be modeledusing mathematics. This raises the question: What is the mathematicalmodel for the mind?  How can a set of physical processes happening within the brain give rise to our mind and its subjective experiences? And therein lies the great mystery: 
...
This Kantian view of Science is illustrated in Figure 4. There is no longer a split between the Physical World and the Mental World, all our perceptions of reality are a creation of our minds and hence are part of the Mental World. The Mathematical Theories of Nature that we come up with are not describing the Noumenon, but are instead modeling the subjective perceptions created by our minds. This might also explain why mathematics is so effective in modeling Nature, this is because both mathematics and Nature (as we experience it) are creations of our minds. 
The Kantian framework says that (perceived) reality is a creation of mind, and at the same time the mind is one of the objects that exists in this reality. This circular path is ofen referred to as a "Strange Loop" in Cognitive Science.

The QBism interpretation of Quantum Mechanics clearly fall within the Kantian Framework, since both say that the practice of science, at the most fundamental level, is a purely subjective endeavour. But about theories of the mind?
...
- If the perseptual priors are very strong, then it results in an actual hallicunation. On the other hand when we are paying closer attention to the external world, then the sensory signals dominate, and this results in a picture that is closer to reality.
- The brain's circuitry incorporates generic models for common objects that we find around us. When the circuit is activated, the brain projects an image of the object onto our visual field, as corrected by the actual sensory data coming from the object.
...
In the previous section we described a Kantian Framework for science that takes into account the fact the mind is one of the objects that exists in our perceived reality, and hence we can try to model it using the tools of Mathematical Modeling. The mind is special case, since we use the mind  for creating perceived reality, and hence in a sense the mind is trying to model itself within the confines of the perceptual boundaries that it has created. Anil Seth's "Controlled Hallicunation" theory of the mind provides mechanisms by which specific aspects of the mind emerge, and it also operates within the Kantian Framework. In this section and the in the succeeding two, we will look at how ANN models exhibit properties that are similar to that of the actual brain, in particular we will look at mathematical models for visual perception and language.
